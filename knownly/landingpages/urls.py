...
urlpatterns = \
    patterns('',
             ...
             url(r'^welcome/learning-to-code/$',
                 TemplateView.as_view(
                     template_name="landingpages/learning-to-code.html"),
                 name='lp-learning-to-code'),
             url(r'^welcome/creatives/$',
                 TemplateView.as_view(
                     template_name="landingpages/creatives.html"),
                 name='lp-creatives'),
             url(r'^welcome/founders/$',
                 TemplateView.as_view(
                     template_name="landingpages/founders.html"),
                 name='lp-founders'),
             url(r'^welcome/startupweekend/$',
                 TemplateView.as_view(
                     template_name="landingpages/startupweekend.html"),
             ...
             url(r'^auth/choose-plan/$',
                 landingpage_views.DropboxAuthSuccessView.as_view(
                     new_customer=True),
