...
urlpatterns = patterns('',
	...
	url(r'^signup/$', views.TemplateView.as_view(template_name="console/signup.html"), name='signup'),
	url(r'^signup_start/$', views.DropboxAuthStartView.as_view(), name='dropbox_auth_start'),
	url(r'^signup_complete/$', views.DropboxAuthCompleteView.as_view(), name='dropbox_auth_finish'),
	url(r'^post_auth_reloader/$', views.TemplateView.as_view(template_name="console/post_auth_reloader.html"), name='post_auth_reloader'),
